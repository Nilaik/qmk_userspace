...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(CYCLE_LAYER, KC_DOWN, KC_UP),
    [2] = LAYOUT(CYCLE_LAYER, KC_LEFT, KC_RIGHT),
    [3] = LAYOUT(CYCLE_LAYER, KC_TAB, KC_ENTER),
    [4] = LAYOUT(CYCLE_LAYER, KC_BACKSPACE, KC_DELETE),
    [5] = LAYOUT(CYCLE_LAYER, KC_SPACE, KC_ESCAPE),
